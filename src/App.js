    ...
    <div>
      <nav className="navBar">
        ...
        <button className="navButtons">
          <a href='https://github.com/musashi-13/Calendarize' style={{ textDecoration: "none", color: "white" }}>
        ...
        <button className="navButtons" onClick={toggleSidebar}>
          <FontAwesomeIcon icon={faBell} size="xl" />
        </button>
        {/* Add Link to navigate to ChatBox */}
        <button className="navButtons">
          <Link to='/ChatBox' style={{ color: 'white' }}>
            Chat
          </Link>
        </button>
      </nav>
      ...
      <div className='filterContainer'>
        <button className={`filterButtons ${showLiked ? 'activeLiked' : 'activeUnliked'}`} onClick={toggleShowLiked}>
